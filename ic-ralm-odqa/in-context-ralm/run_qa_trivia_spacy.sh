...
dataset_short_name=dpr-trivia-test
...
# main_name="msmarco-unicoil-nq-test"

for threshold in 0.5 0.6 0.7 0.8 0.9; do
  for method in "spacy"; do
#   for method in "tfidf" "spacy"; do
    ...
    # dataset_path=data/$main_name-reranked-$method-$threshold.json
    # output_dir=output_msmarco_nq-test/output_$main_name-$method-$threshold
